...
class CreateClientWindow(Toplevel,CenterWidgetMixin):
    ...
    def build(self):
        ...
        Label(frame,text="DNI (2 numeros y una Mayúscula)").grid(row=0,column=0)
        Label(frame,text="Nombre (de 2 a 30 Carácteres)").grid(row=0,column=1)
        Label(frame,text="Apellido (de 2 a 30 Carácteres)").grid(row=0,column=2)
    ...
    def validate(self,event,index):
        ...
        #Hacer que el boton crear ya se habilite
